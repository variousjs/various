...
D.$onMessage = function (message) {
  dispatch({
    message: "".concat(message.type, "|").concat(message.value || '-')
  });
};

var dd = connect('message')(D);
}();
